...
import { KeyboardIcons } from '../../Shared/utils/Icons';
...
export default function VirtualKeyboard({ midi, appendLog, isConnected }) {
    ...
    return (
        <div style={{ marginTop: '12px' }}>
            ...
            >
                <span style={{ width: '20px', height: '20px', display: 'inline-block', color: active ? 'rgb(81, 171, 81)' : '#ffffff' }}>
                    <KeyboardIcons.KEYBOARD />
                </span>
