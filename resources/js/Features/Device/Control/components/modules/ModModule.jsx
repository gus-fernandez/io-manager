    ...
    return (
        <Module id={id} title="MOD">
            <div className="grid gap-x-4 justify-items-center items-end" style={{ gridTemplateColumns: 'repeat(4, 40px)' }}>
                ...
                <IoButton label="Bend" cc={CC.SELECT_BEND} activeCc={activeGroupCc} setActiveCc={setActiveGroupCc} send={sendCC} appendLog={appendLog} />
                <IoButton label="Vel" cc={CC.SELECT_VEL} activeCc={activeGroupCc} setActiveCc={setActiveGroupCc} send={sendCC} appendLog={appendLog} />
                <IoButton label="Mod" cc={CC.SELECT_MODWHEEL} activeCc={activeGroupCc} setActiveCc={setActiveGroupCc} send={sendCC} appendLog={appendLog} />
                <IoButton label="M-Sync" cc={CC.MODWHEEL_SYNC} value={values.MODWHEEL_SYNC ?? 0} send={sendCC} appendLog={appendLog} />
            </div>
            <div className="flex gap-x-4 justify-center">
                <div className="grid gap-x-4 justify-items-center items-end" style={{ gridTemplateColumns: 'repeat(2, 40px)' }}>
                    ...
                    <IoBend label="Bend" channel={0} className="row-span-2" send={sendBend} appendLog={appendLog} />
                    <IoSlider label="Mod" cc={CC.MODWHEEL} value={values.MODWHEEL ?? 0} className="row-span-2" send={sendCC} appendLog={appendLog} />
                </div>
                <div className="grid gap-x-4 justify-items-center items-end" style={{ gridTemplateColumns: 'repeat(2, 40px)' }}>
                    <IoKnob label="M-Rate" cc={CC.MOD_RATE} value={values.MOD_RATE ?? 100} send={sendCC} appendLog={appendLog} />
                    
                    {activeGroupCc === CC.SELECT_BEND && (
                        <>
                            <IoKnob label="B-Freq" cc={CC.BEND_TO_FREQ} value={values.BEND_TO_FREQ ?? 100} send={sendCC} appendLog={appendLog} />
                            <IoKnob label="B-Cut" cc={CC.BEND_TO_CUT} value={values.BEND_TO_CUT ?? 100} send={sendCC} appendLog={appendLog} />
                    ...
                    {activeGroupCc === CC.SELECT_VEL && (
                        <>
                            <IoKnob label="_" value={0} />
                            <IoKnob label="V-Cut" cc={CC.VEL_TO_CUT} value={values.VEL_TO_CUT ?? 100} send={sendCC} appendLog={appendLog} />
                            <IoKnob label="V-Vol" cc={CC.VEL_TO_VOL} value={values.VEL_TO_VOL ?? 100} send={sendCC} appendLog={appendLog} />
                        </>
                    )}
                    {activeGroupCc === CC.SELECT_MODWHEEL && (
                        <>
                            <IoKnob label="M-Freq" cc={CC.MOD_TO_FREQ} value={values.MOD_TO_FREQ ?? 100} send={sendCC} appendLog={appendLog} />
                            <IoKnob label="M-Cut" cc={CC.MOD_TO_CUT} value={values.MOD_TO_CUT ?? 100} send={sendCC} appendLog={appendLog} />
                            <IoKnob label="M-Pan" cc={CC.MOD_TO_PAN} value={values.MOD_TO_PAN ?? 100} send={sendCC} appendLog={appendLog} />
                        </>
                    )}
                </div>
            </div>
